...
public class SignupOne extends JFrame implements ActionListener {
    ...
    // when next button is clicked following action will be performed
    @Override
    public void actionPerformed(ActionEvent e){
        ...
        // as mysql is external entity we need to handle the exceptions
        try {
            if (name.equals("")) {
                JOptionPane.showMessageDialog(null, "Name is Required");
            }
            // Here more form validation will be done later
