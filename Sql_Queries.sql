...
-- for amount of money stored in account data
create table amountDetails(Card_Number varchar(30), Pin varchar(10),Date varchar(50),Type varchar(20),Amount varchar(20));
